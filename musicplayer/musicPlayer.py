...
class musicPlayer:
    def __init__(self,root):
        ...
        self.count=0
        for pos,song in enumerate(os.listdir('/Users/nilaygaitonde/Documents/Projects/OneDayProjects/musicplayer/music')):
    ...
    def moveFile(self):
        for files in os.listdir('/Users/nilaygaitonde/Documents/Projects/OneDayProjects/musicplayer/'):
            if(files.endswith('.mp3')):
                shutil.move('/Users/nilaygaitonde/Documents/Projects/OneDayProjects/musicplayer/'+files,'/Users/nilaygaitonde/Documents/Projects/OneDayProjects/musicplayer/music')
    ...
    def play(self):
        ...
        mixer.music.load('/Users/nilaygaitonde/Documents/Projects/OneDayProjects/musicplayer/music/'+song)
        mixer.music.play()
    def pause(self):
        mixer.music.pause()
